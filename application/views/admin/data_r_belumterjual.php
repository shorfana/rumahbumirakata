		...
		<div class="row small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">Rumah Belum Terjual</h4>
					<!-- /.box-title -->
					...
					<a href="<?php echo base_url() ?>admin/excel2"  type="button" class="btn btn-primary btn-bordered waves-effect waves-light"> PriviewExport to excel</a>
						<br>
						<br>
						<br>
