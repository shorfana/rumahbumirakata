		...
		<div class="row small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
					<form data-toggle="validator" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>admin/act_edtRumah">
						<h4>Tambah Data Rumah</h4>
						<div class="form-group">
							<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $id ?>" placeholder="Cina Saffary" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama_rumah" name="nama_rumah" value="<?php echo $nama_rumah ?>" required>
						</div>
						<div class="form-group">
							<label for="inputName" class="control-label">Harga Rumah</label>
							<input type="text" class="form-control" name="harga_rumah" id="harga_rumah" value="<?php echo $harga_rumah ?>"  required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="luas_bangunan" class="form-control" id="inputName" value="<?php echo $luas_bangunan ?>" placeholder="45 m²" required>
						</div>
						<div class="form-group">
							<label for="inputName" class="control-label">Luas Tanah</label>
							<input type="text" name="luas_tanah" class="form-control" id="inputName" value="<?php echo $luas_tanah ?>" placeholder="52 m²" required>
						</div>
						<div class="form-group">
							<p>Serifikat</p>
