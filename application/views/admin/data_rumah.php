					...
					<table id="example" class="table table-striped table-bordered display" style="width:100%">
						...
						<tbody>
							...
							<tr>
									...
									<td>
										<a href="<?php echo site_url('admin/edit_rumah/'.$r->id) ?>" type="button" class="btn btn-primary btn-sm waves-effect waves-light">edit</button>
										<a href="<?php echo site_url('admin/delete/'.$r->id) ?>" type="button" class="btn btn-primary btn-sm waves-effect waves-light">hapus</button>
									</td>
							</tr>
							<?php endforeach ?>
						</tbody>
